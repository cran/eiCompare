...
Building off of existing parallel processing packages such as `foreach` and `doParallel`,  this package includes parallel processing capabiltiies to speed up ecological inference analyses.
